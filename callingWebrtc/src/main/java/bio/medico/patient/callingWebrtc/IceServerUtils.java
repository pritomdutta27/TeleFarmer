...
public class IceServerUtils {
    ...
    public static List<PeerConnection.IceServer> getIceServersApiGate() {
        ...
        String[] turnServer = {
                ...
                "turn:xturn.apigate.pro:3478?transport=tcp",
                "turn:xturn.apigate.pro:3479?transport=tcp",
                "turns:xturn.apigate.pro:5350?transport=tcp",
                "turns:xturn.apigate.pro:5349?transport=tcp"
        };
    ...
    public static List<PeerConnection.IceServer> getIceServersMetadata() {
        ResponseMetaInfo.MetaData metaData = LocalData.getMetaInfoMetaData();


        if (metaData == null) {
            return new ArrayList<>();
        }
        ResponseMetaInfo.TurnAuth turnAuth = metaData.getTurnAuth();
